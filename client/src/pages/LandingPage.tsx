...
const LandingPage = ({
    ...
    return (
        <div className="text-[14px] overflow-hidden h-screen">
            ...
            <div className="w-[100vw] overflow-hidden h-[calc(100vh-60px)] absolute bg-white">
            ...
            <p className="absolute md:w-1/2 w-3/4 text-center mx-auto mt-[50px] z-50 inset-0 top-[300px]">
                Reach the pinnacle of your coding potential with FireCode.
                Elevate your skills, conquer challenges, and excel in technical
                interviews, propelling your programming journey to new heights.
            </p>
            <div className=" absolute top-[500px] left-1/2 -translate-x-1/2 z-50">
                <Link
                    to="/signup"
                    className=" relative ml-[8px] font-bold inline-block from-orange-500 to-red-600 rounded-md text-black text-[18px] hover:bg-red-800"
                >
                    <div className="w-full h-full bg-[#B3A1CF] font-suse text-purple py-[10px] px-[40px] rounded-[30px] border border-black hover:bg-[#00000000] hover:border-[#00000000] hover:text-black transition active:bg-red-700">
                        Let's meet!
                    </div>
                </Link>
            </div>
